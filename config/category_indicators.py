...
CATEGORY_INDICATOR_MAP = {
    "GEO": {
        ...
        "default_baseline": 2,
        "indicators": [
            {"name": "usgs_earthquake_count",   "source": "USGS",       "weight": 0.23, "beta": "direct_causal",       "time_scale": "fast"},
            {"name": "usgs_significant_count",  "source": "USGS",       "weight": 0.19, "beta": "direct_causal",       "time_scale": "fast"},
            {"name": "usgs_max_magnitude",      "source": "USGS",       "weight": 0.19, "beta": "strong_correlation",  "time_scale": "fast"},
            {"name": "noaa_extreme_events",     "source": "NOAA",       "weight": 0.14, "beta": "strong_correlation",  "time_scale": "slow"},
    ...
    "ENRG": {
        ...
        "default_baseline": 3,
        "indicators": [
            {"name": "eia_crude_oil_price",     "source": "EIA",        "weight": 0.23, "beta": "direct_causal",       "time_scale": "fast"},
            {"name": "eia_natural_gas_price",   "source": "EIA",        "weight": 0.18, "beta": "direct_causal",       "time_scale": "fast"},
            {"name": "eia_energy_volatility",   "source": "EIA",        "weight": 0.14, "beta": "strong_correlation",  "time_scale": "fast"},
            {"name": "eia_strategic_reserve_level","source": "EIA",     "weight": 0.09, "beta": "moderate_correlation","time_scale": "medium"},
            {"name": "acled_conflict_events",   "source": "ACLED",      "weight": 0.09, "beta": "moderate_correlation","time_scale": "medium"},
            {"name": "gdelt_crisis_intensity",  "source": "GDELT",      "weight": 0.09, "beta": "weak_correlation",    "time_scale": "fast"},
    ...
    "TECH": {
        ...
        "default_baseline": 3,
        "indicators": [
            {"name": "nvd_total_cves",          "source": "NVD",        "weight": 0.13, "beta": "moderate_correlation","time_scale": "fast"},
            {"name": "nvd_critical_count",      "source": "NVD",        "weight": 0.13, "beta": "strong_correlation",  "time_scale": "fast"},
    ...
    "SUPL": {
        ...
        "default_baseline": 3,
        "indicators": [
            {"name": "eia_crude_oil_price",     "source": "EIA",        "weight": 0.13, "beta": "strong_correlation",  "time_scale": "fast"},
            {"name": "eia_energy_volatility",   "source": "EIA",        "weight": 0.09, "beta": "moderate_correlation","time_scale": "fast"},
            {"name": "fao_food_price_index",    "source": "FAO",        "weight": 0.13, "beta": "strong_correlation",  "time_scale": "medium"},
            {"name": "fao_supply_stress",       "source": "FAO",        "weight": 0.13, "beta": "direct_causal",       "time_scale": "medium"},
            {"name": "acled_conflict_events",   "source": "ACLED",      "weight": 0.09, "beta": "moderate_correlation","time_scale": "medium"},
            {"name": "gdelt_crisis_intensity",  "source": "GDELT",      "weight": 0.09, "beta": "moderate_correlation","time_scale": "fast"},
            {"name": "world_bank_gdp_growth",   "source": "WORLD_BANK", "weight": 0.09, "beta": "weak_correlation",    "time_scale": "slow"},
    ...
    "SYST": {
        ...
        "default_baseline": 2,
        "indicators": [
            {"name": "fred_vix_index",          "source": "FRED",       "weight": 0.14, "beta": "direct_causal",       "time_scale": "fast"},
            {"name": "fred_unemployment_rate",  "source": "FRED",       "weight": 0.09, "beta": "strong_correlation",  "time_scale": "medium"},
            {"name": "fred_inflation_rate",     "source": "FRED",       "weight": 0.09, "beta": "moderate_correlation","time_scale": "medium"},
            {"name": "imf_world_gdp_growth",    "source": "IMF",        "weight": 0.09, "beta": "strong_correlation",  "time_scale": "slow"},
            {"name": "world_bank_gdp_growth",   "source": "WORLD_BANK", "weight": 0.09, "beta": "moderate_correlation","time_scale": "slow"},
            {"name": "acled_conflict_events",   "source": "ACLED",      "weight": 0.09, "beta": "moderate_correlation","time_scale": "medium"},
            {"name": "gdelt_crisis_intensity",  "source": "GDELT",      "weight": 0.09, "beta": "moderate_correlation","time_scale": "fast"},
            {"name": "eia_energy_volatility",   "source": "EIA",        "weight": 0.09, "beta": "weak_correlation",    "time_scale": "fast"},
    ...
    "CLIM": {
        ...
        "default_baseline": 3,
        "indicators": [
            {"name": "noaa_temp_anomaly",       "source": "NOAA",       "weight": 0.21, "beta": "direct_causal",       "time_scale": "slow"},
            {"name": "noaa_extreme_events",     "source": "NOAA",       "weight": 0.17, "beta": "direct_causal",       "time_scale": "slow"},
            {"name": "noaa_climate_risk",       "source": "NOAA",       "weight": 0.13, "beta": "strong_correlation",  "time_scale": "slow"},
            {"name": "noaa_precipitation_index","source": "NOAA",       "weight": 0.08, "beta": "moderate_correlation","time_scale": "slow"},
            {"name": "fao_food_security_risk",  "source": "FAO",        "weight": 0.13, "beta": "strong_correlation",  "time_scale": "slow"},
            {"name": "fao_food_price_index",    "source": "FAO",        "weight": 0.08, "beta": "moderate_correlation","time_scale": "medium"},
            {"name": "eia_crude_oil_price",     "source": "EIA",        "weight": 0.04, "beta": "weak_correlation",    "time_scale": "fast"},
    ...
    "ECO": {
        ...
        "default_baseline": 3,
        "indicators": [
            {"name": "fred_unemployment_rate",  "source": "FRED",       "weight": 0.18, "beta": "direct_causal",       "time_scale": "medium"},
            {"name": "fred_inflation_rate",     "source": "FRED",       "weight": 0.13, "beta": "strong_correlation",  "time_scale": "medium"},
            {"name": "fred_vix_index",          "source": "FRED",       "weight": 0.13, "beta": "strong_correlation",  "time_scale": "fast"},
            {"name": "world_bank_gdp_growth",   "source": "WORLD_BANK", "weight": 0.18, "beta": "direct_causal",       "time_scale": "slow"},
            {"name": "imf_world_gdp_growth",    "source": "IMF",        "weight": 0.13, "beta": "strong_correlation",  "time_scale": "slow"},
    ...
    "POL": {
        ...
        "default_baseline": 3,
        "indicators": [
            {"name": "acled_conflict_events",   "source": "ACLED",      "weight": 0.23, "beta": "direct_causal",       "time_scale": "medium"},
            {"name": "acled_fatalities",        "source": "ACLED",      "weight": 0.14, "beta": "strong_correlation",  "time_scale": "medium"},
            {"name": "gdelt_crisis_intensity",  "source": "GDELT",      "weight": 0.19, "beta": "strong_correlation",  "time_scale": "fast"},
            {"name": "gdelt_event_volume",      "source": "GDELT",      "weight": 0.14, "beta": "moderate_correlation","time_scale": "fast"},
