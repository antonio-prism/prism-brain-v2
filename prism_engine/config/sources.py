"""
PRISM Engine — Data source definitions.
...
TYPE_A_SOURCES = {
    ...
    "A07": {
        ...
        "endpoint": "https://ucdpapi.pcr.uu.se/api/ucdpprioconflict/25.1",
        "auth": "none",
        "format": "json",
        "rate_limit": "5000 requests/day",
        "events_served": ["STR-GEO-001", "STR-GEO-004", "STR-GEO-005"],
        "credential_key": None,
        "note": "Replaces ACLED (which requires paid Research-tier access). UCDP is free, no key needed.",
    },
    "A08": {
        "name": "EM-DAT",
