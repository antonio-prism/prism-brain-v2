...
PHASE1_EVENTS = {
    ...
    "STR-GEO-001": {
        ...
        "method": "A",
        "prior_source": "acled",
        "primary_sources": ["A07", "A12"],
        "modifier_sources": ["A06"],
        "observation_window": "2018-2024",
        "observation_years": 7,
        "acled_event_type": "Battles",
        "acled_countries": "TOP20_SUPPLIERS",
        "description": "Count years with at least 1 battle event in any TOP20 supplier country (ACLED from 2018)",
    },
    "STR-TRD-001": {
